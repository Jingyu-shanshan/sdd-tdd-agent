...
Maven and Gradle installations. Therefore Java acceptance depends on the
push-triggered hosted Ubuntu matrix and is reported from that run, not inferred
from Python planner tests.
