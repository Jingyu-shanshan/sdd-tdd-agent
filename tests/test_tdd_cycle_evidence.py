...
def test_should_clear_stale_execution_evidence_for_new_cycle(tmp_path: Path) -> None:
    ...
    state = {
        ...
        "test_source": {"test_id": "TC1", "file_path": "old", "sha256": "old"},
        "red_evidence": {"test_id": "TC1", "returncode": 1},
    }
    ...
    assert "test_source" not in updated
    assert "red_evidence" not in updated
